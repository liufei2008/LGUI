...
void FLGUIEditorModule::StartupModule()
{
	...
	PrefabOverrideDataViewer = SNew(SLGUIPrefabOverrideDataViewer)
		.IsEnabled_Raw(this, &FLGUIEditorModule::CanCheckPrefabOverrideParameter)
		;
}
...
void FLGUIEditorModule::RefreshPrefabOverrideParameterViewerOnLevelEditor(const TArray<FLGUIPrefabOverrideParameterData>& ObjectOverrideParameterArray)
{
	PrefabOverrideDataViewer->RefreshDataContent(ObjectOverrideParameterArray);
}
	...
	//prefab
	{
		MenuBuilder.BeginSection("Prefab", LOCTEXT("Prefab", "Prefab"));
		{
			...
			MenuBuilder.AddMenuEntry(
				...
				FSlateIcon(),
				FUIAction(FExecuteAction::CreateStatic(&LGUIEditorTools::ApplyPrefabInLevelEditor)
			...
			//	, LOCTEXT("OverrideParameters", "Override Parameters")
			//);
		}
