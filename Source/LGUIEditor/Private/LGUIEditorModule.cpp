...
void FLGUIEditorModule::StartupModule()
{
	...
	//blueprint
	{
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULGUILifeCycleBehaviour::StaticClass(), TEXT("AwakeBP"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULGUILifeCycleBehaviour::StaticClass(), TEXT("StartBP"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, ULGUILifeCycleBehaviour::StaticClass(), TEXT("UpdateBP"));
	...
	//prefab
	OnPostEngineInit_DelegateHandle = FCoreDelegates::OnPostEngineInit.AddLambda([this] {
		FCoreDelegates::OnPostEngineInit.Remove(OnPostEngineInit_DelegateHandle);
		ULGUIEditorManagerObject::GeneratePrefabAgentInPreviewWorld();
		});
}
...
void FLGUIEditorModule::ShutdownModule()
{
	...
	if (OnPostEngineInit_DelegateHandle.IsValid())
	{
		FCoreDelegates::OnPostEngineInit.Remove(OnPostEngineInit_DelegateHandle);
	}
