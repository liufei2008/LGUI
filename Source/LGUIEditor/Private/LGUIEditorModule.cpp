...
void FLGUIEditorModule::StartupModule()
{
	...
	//blueprint
	{
		...
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUIBatchGeometryRenderable_BP::StaticClass(), TEXT("ReceiveOnBeforeCreateOrUpdateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUIBatchGeometryRenderable_BP::StaticClass(), TEXT("ReceiveOnCreateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUIBatchGeometryRenderable_BP::StaticClass(), TEXT("ReceiveOnUpdateGeometry"));

		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUISpriteBase_BP::StaticClass(), TEXT("ReceiveOnBeforeCreateOrUpdateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUISpriteBase_BP::StaticClass(), TEXT("ReceiveOnCreateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUISpriteBase_BP::StaticClass(), TEXT("ReceiveOnUpdateGeometry"));

		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUITextureBase_BP::StaticClass(), TEXT("ReceiveOnBeforeCreateOrUpdateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUITextureBase_BP::StaticClass(), TEXT("ReceiveOnCreateGeometry"));
		FKismetEditorUtilities::RegisterAutoGeneratedDefaultEvent(this, UUITextureBase_BP::StaticClass(), TEXT("ReceiveOnUpdateGeometry"));
	}
