...
namespace LGUISceneOutliner
{
				...
				[
					...
					[
						...
						[
							...
							.ToolTipText(FText::FromString(FString(TEXT("The number is the drawcall count generated by this LGUICanvas or UIRendable."))))
	...
	bool FLGUISceneOutlinerInfoColumn::CanShowPrefabIcon(FSceneOutlinerTreeItemRef TreeItem) const
	{
		if (AActor* actor = GetActorFromTreeItem(TreeItem))
		{
