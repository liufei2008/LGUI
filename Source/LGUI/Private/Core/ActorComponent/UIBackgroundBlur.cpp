...
)
{
	...
	{
		//render vertical
		FRHIRenderPassInfo RPInfoVertical(BlurEffectRenderTexture1, ERenderTargetActions::Load_Store);
		RHICmdList.BeginRenderPass(RPInfoVertical, TEXT("UIBackgroundBlurVertical"));
		...
		//render horizontal
		FRHIRenderPassInfo RPInfoHorizontal(ScreenImage, ERenderTargetActions::Load_Store);
		RHICmdList.BeginRenderPass(RPInfoHorizontal, TEXT("UIBackgroundBlurHorizontal"));
		VertexShader->SetParameters(RHICmdList, ViewProjectionMatrix);
