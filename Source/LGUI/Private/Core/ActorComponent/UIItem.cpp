...
bool UUIItem::CalculateLayoutRelatedParameters()
{
	...
	if (LGUIUtils::IsVectorNotEqual(this->RelativeLocation, resultLocation))
	{
...
{
	if (LGUIUtils::IsVectorNotEqual(this->RelativeLocation, newLocation))
	{
		MarkLayoutDirty();
...
void UUIItem::SetUIRelativeLocationAndRotation(const FVector& newLocation, const FQuat& newRotation)
{
	...
	if (LGUIUtils::IsVectorNotEqual(RelativeLocation, newLocation))
	{
