...
bool UUIText::MoveCaret(int32 moveType, int32& inOutCaretPositionIndex, int32& inOutCaretPositionLineIndex, FVector2D& inOutCaretPosition)
{
...
void UUIText::FindCaretByIndex(int32& inOutCaretPositionIndex, FVector2D& outCaretPosition, int32& outCaretPositionLineIndex, int32& outVisibleCaretStartIndex)
{
	UpdateCacheTextGeometry();
	auto& cacheLinePropertyArray = CacheTextGeometryData.cacheLinePropertyArray;
...
void UUIText::FindCaret(FVector2D& inOutCaretPosition, int32 inCaretPositionLineIndex, int32& outCaretPositionIndex)
{
