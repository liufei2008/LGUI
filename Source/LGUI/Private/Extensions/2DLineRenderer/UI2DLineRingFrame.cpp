...
{
	return ALTweenActor::To(this->GetWorld(), FLTweenFloatGetterFunction::CreateUObject(this, &UUI2DLineRingFrame::GetAngleBegin), FLTweenFloatSetterFunction::CreateUObject(this, &UUI2DLineRingFrame::SetAngleBegin), endValue, duration)
...
{
	return ALTweenActor::To(this->GetWorld(), FLTweenFloatGetterFunction::CreateUObject(this, &UUI2DLineRingFrame::GetAngleEnd), FLTweenFloatSetterFunction::CreateUObject(this, &UUI2DLineRingFrame::SetAngleEnd), endValue, duration)
		->SetEase(easeType)->SetDelay(delay);
}
ULTweener* UUI2DLineRingFrame::FrameWidthTo(float endValue, float duration, float delay, LTweenEase easeType)
{
	return ALTweenActor::To(this->GetWorld(), FLTweenFloatGetterFunction::CreateUObject(this, &UUI2DLineRingFrame::GetFrameWidth), FLTweenFloatSetterFunction::CreateUObject(this, &UUI2DLineRingFrame::SetFrameWidth), endValue, duration)
		->SetEase(easeType)->SetDelay(delay);
}