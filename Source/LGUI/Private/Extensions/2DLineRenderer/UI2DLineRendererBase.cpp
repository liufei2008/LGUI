...
{
	return ALTweenActor::To(FloatGetterFunction::CreateUObject(this, &UUI2DLineRendererBase::GetLineWidth), FloatSetterFunction::CreateUObject(this, &UUI2DLineRendererBase::SetLineWidth), endValue, duration)
...
{
	return ALTweenActor::To(FloatGetterFunction::CreateUObject(this, &UUI2DLineRendererBase::GetGrowValue), FloatSetterFunction::CreateUObject(this, &UUI2DLineRendererBase::SetGrowValue), endValue, duration)
		->SetDelay(delay)->SetEase(easeType);
}