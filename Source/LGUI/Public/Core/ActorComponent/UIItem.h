...
private:
	TInlineComponentArray<class UUIComponentBase*> UIBaseComponentArray;
...
public:
	void AddUIBaseComponent(class UUIComponentBase* InComp) { UIBaseComponentArray.Add(InComp); }
	void RemoveUIBaseComponent(class UUIComponentBase* InComp) { UIBaseComponentArray.Remove(InComp); }
