	...
	//uv
	{
		...
		auto tempFontSize = richTextProperty.size * oneDivideFontSize;
		{
			...
			//bold and font size
			{
				...
				vertices[verticesStartIndex].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + 1].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + 2].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + 3].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
			}
		...
		if (richTextProperty.underline)
		{
			...
			//bold and font size, bold is not needed for underline and strikethrough, but font size is needed
			{
				...
				vertices[verticesStartIndex + addVertCount].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + addVertCount + 1].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + addVertCount + 2].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
				vertices[verticesStartIndex + addVertCount + 3].TextureCoordinate[1] = FVector2D(tempBoldSize, tempFontSize);
			}
